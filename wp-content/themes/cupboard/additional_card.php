...
/*
Template Name: Шаблон "Доп карточка товара"
Template Post Type: additional_goods
*/
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumbs fjc-s fai-c mt-20 mb-60">
                    ...
                    <li class="fjc-s fai-c">
                        <span class="fjc-c fai-c pl-10 pr-10">—</span>
                        <a href="<?= home_url() ?>/product_item/<?= get_the_tags()[0]->name; ?>"
                           class="fs-14 fw-700 link link__default link__default_b">
                            <?php Catalog::getTitle(['post_type' => 'product_item', 'name' => $category_name = get_the_tags()[0]->name], 'product_item_title'); ?>
                        </a>
                    </li>
...
//                    debug(get_the_tags()[0]->name );
                    ?>

                    <li class="fjc-s fai-c">
                        <span class="fjc-c fai-c pl-10 pr-10">—</span>
                        <?php Catalog::getTitle(['post_type' => 'additional_goods', 'name' => $category_name = get_query_var('name')], 'product_item_title'); ?>
                    </li>
            ...
            <div class="col-lg-6">
                <div class="card-description">
                    <h1 class="title title__h1">
                        <?php Catalog::getTitle(['post_type' => 'additional_goods', 'name' => get_query_var('name')], 'product_item_title') ?>
                    </h1>
                    <div class="mt-30">
                        <div class="c-red fs-24 fw-700">
                            ...
                            <span>
                                ...
                                Catalog::getTitle(['post_type' => 'additional_goods', 'name' => get_query_var('name')], 'product_czena_tovara') ?></span>
                            руб
                        </div>
                    </div>
