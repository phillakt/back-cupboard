                ...
                <div class="mt-30">
                    <div class="fjc-c fai-c ffd-column">
                        ...
                        <div class="desc desc__sm mb-30 c-black">
                            Менеджер ответит на Ваш вопрос в ближайшее время
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                ...
                <ul class="ui-ul">
                    <li class="mb-10">
                        ...
                        <a href="#!" class="c-white fs-14 link link__default link__default_w">
                            Вконтакте
                        </a>
                    </li>
                    <li class="mb-10">
                        <img src="<?= get_template_directory_uri() ?>/img/icons/footer/ico_insta.svg" alt="ico_insta">
                        <a href="#!" class="c-white fs-14 link link__default link__default_w">
                            Инстаграм
                        </a>
                    </li>
                    <li class="mb-10">
                        <img src="<?= get_template_directory_uri() ?>/img/icons/footer/ico_mail.svg" alt="ico_mail">
                        <a href="#!" class="c-white fs-14 link link__default link__default_w">
                            Почта
                        </a>
                    </li>
...
<section class="substrate-menu-mobile"></section>

<section class="menu-mobile-box">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
